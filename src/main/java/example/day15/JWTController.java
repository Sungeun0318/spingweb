...
public class JWTController {
    ...
    // [1] JWT토큰생성 == 데이터를 암호화하기 == 로그인정보 vs 세션(HTTP)
    ...
    @GetMapping("/read") // http://localhost:8080/api/jwt/read?토큰=eyJhbGciOiJIUzI1NiJ9.eyJkYXRhIjoi67CU64KY64KYIiwiaWF0IjoxNzc0MzI2ODczLCJleHAiOjE3NzQzMjY4OTN9.oiFH2vyIbwQI8xQzTswigKlOr9rt-TzkYOPwl3QCwgA
